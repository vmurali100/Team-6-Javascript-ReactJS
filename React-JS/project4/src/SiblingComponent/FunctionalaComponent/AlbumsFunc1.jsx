...
export const AlbumsFunc1=({sendmessage,message,sendperson,person,sendalbum,album})=>{
    const[]=useState(
        message="Hello Team India",
        person={
            userId:26,
            id:2001,
            title:"ViartKohli"
    ...
    return(
        <div>
            ...
            <button onClick={()=>{sendalbum(album)}}>sendalbums</button>
        </div>
    )
}
var allalbum=[
