...
export default class Ccommentschild extends Component{
    constructor(props){
        super(props)
        this.state={
            message:"",
    ...
    render(){
        const{receivemessage,receiveperson,receivecomments}=this.props
        return(
            <div>
                <button onClick={()=>{receivemessage("hello from the class and child to parent")}}>send message</button>
                <button onClick={()=>{receiveperson(allcomments[0])}}>send person</button>
                <button onClick={()=>{receivecomments(allcomments)}}>send comments</button>
            </div>
        )
    }
}
