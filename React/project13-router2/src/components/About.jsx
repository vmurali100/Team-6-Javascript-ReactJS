...
export const About = () => {
    return (
        <div>
           <ul>
            <li> <img src="images/react.jpg" alt="" width="512px" height="400px" /></li>
            <li>
            <i>
                ...
                library[3] for building user interfaces based on UI components. It is maintained by Meta
                 (formerly Facebook) and a community of individual developers and companies.[4][5][6] React 
                 can be used as a base in the development of single-page, mobile, or server-rendered 
