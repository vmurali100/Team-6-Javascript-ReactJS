...
export default class CommentChild5 extends Component {
    constructor(props){
        super(props)
        this.state = {
            message: "",
    ...
    render(){
        ...
        return(
            <div>
                ...
                <br />
                <button onClick={()=>{receiveObject(allComments[0])}}>Send Person</button>
                <br />
                <button onClick={()=>{receiveArray(allComments)}}>Send Users</button>
