...
export const Filltext6Child =({getdata})=>{
    const [userAlbumsData,setuserAlbumsData]=useState(Allalbums)
    const sendData=()=>{
        getdata (userAlbumsData)
    }
    return(
        <div>
            <button onClick={sendData}>getdata </button>
        </div>
    )
