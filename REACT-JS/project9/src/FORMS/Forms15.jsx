...
const Forms15 = () => {
    ...
    const getAllUsers = () => {
        axios.get("http://localhost:3000/Forms15").then((response) => {
    ...
    const addUser = () => {
        console.log(person)
        axios.post("http://localhost:3000/Forms15/", person).then((response) => {
    ...
    const deleteuser = (userDetails) => {
        axios.delete("http://localhost:3000/Forms15/" + userDetails.id).then((response) => {
            getAllUsers()
    ...
    const updateuser = () => {
        axios.put("http://localhost:3000/Forms15/" + person.id, person).then(() => {
            getAllUsers();
            clearUser();
            setisEdit(false)
        })
