...
export class Commentschildd extends Component{
    constructor(){
        super()
        this.state={
            message:"",
    ...
    render(){
        const{recievemessage,recievecomment,recieveusers}=this.props
        return(
            <div>
                <button onClick={()=>{recievemessage("hello comments")}}>send message</button>
                <button onClick={()=>{recievecomment(allcomment[0])}}>send comment</button>
                <button onClick={()=>{recieveusers(allcomment)}}>send user</button>
            </div>
        )
    }
