...
const Forms16 = () => {
    ...
    const getAllUsers = () => {
        axios.get(" http://localhost:3000/forms16").then((response) => {
    ...
    const deleteuser = (userDetails) => {
        axios.delete(" http://localhost:3000/forms16/" + userDetails.id).then((response) => {
            getAllUsers()
    ...
    const updateuser = () => {
        axios.put(" http://localhost:3000/forms16/" + person.id, person).then(() => {
            getAllUsers();
            clearUser();
            setisEdit(false)
        })
