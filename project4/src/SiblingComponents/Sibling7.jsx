...
export default class Sibling7 extends Component{
    constructor(props){
        super(props)
        this.state={
            village:"my village name is perumalpalli",
            posts:{
                fname:"puttavari",
                lname:"palli"
            },
    ...
    render(){
        const {sendvillage,sendposts,senddistrict}=this.props;
        const {village,posts,district}=this.state;
        return <div>
            <button onClick={()=>{sendvillage(village)}}>send village</button>
            <button onClick={()=>{sendposts(posts)}}>send posts</button>
