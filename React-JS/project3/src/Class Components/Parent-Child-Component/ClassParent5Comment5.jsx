...
import { ClassChild5Comment5 } from "./ClassChild5Comment5";

export class ClassParent5Comment5 extends Component {
    constructor (props){
        super(props)
        this.state={
            Commenets:[
    ...
    render(){
        return(
            <div>
                <ClassChild5Comment5 allComments={this.state.Commenets}/>
            </div>
        )
    }
}