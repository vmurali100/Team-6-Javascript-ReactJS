...
const Child5=({sendalbum})=>{
    const[albumsdetails,setalbums]=useState(allalbum)
    const sendalbumtoparent=()=>{
         sendalbum(albumsdetails)
    }
    return(

        <div>
            <button onClick={sendalbumtoparent}>send album to parent</button>
        </div>
    )
