...
export const CommFun1=({message,sendmessage,sendperson,person,comments,sendcomments}) => {
    const[]=useState(
        message="Hi welcome to CommFun1",
        person={
            name:"Srividya",
    ...
    return(
        <div>
            ...
            <button onClick={()=>{sendcomments(comments)}}>send comments</button>
        </div>
    )
}
var allComments =
