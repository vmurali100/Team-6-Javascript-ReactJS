...
import { Albumschilddd } from "./Albumschilddd"

export const Albumsss=()=>{
    const[albumdetails,setalbumdetails]=useState([])
    const sendalbums=()=>{
        setalbumdetails(allalbums)
    }
    return(
        <div>
            <button onClick={sendalbums}>send albums</button>
            <Albumschilddd albumdetails={albumdetails}/>
        </div>
    )
}
var allalbums=[
